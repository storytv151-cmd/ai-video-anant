...
const environment = Object.freeze({
  app: {
    ...
    enableRequestIdHeader: parseBoolean(
      process.env.ENABLE_REQUEST_ID_HEADER,
      true,
    ),
  },
  database: {
  ...
  integrations: {
    ...
    digitalOceanSpaces: {
      ...
      cdn: ensureValidUrl(
        process.env.DIGITALOCEAN_SPACES_CDN || "",
    ...
    googlePlay: {
      ...
      rtdnAuthorizedEmails: parseOrigins(
        process.env.GOOGLE_RTDN_AUTHORIZED_EMAILS || "",
      ),
