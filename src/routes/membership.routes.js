...
import { checkMembershipFeature, getMembershipFeatures } from '../controllers/membership.controller.js';
import membershipValidator from '../validators/membership.validator.js';

const membershipRouter = Router();

membershipRouter.get('/features', authenticate, asyncHandler(getMembershipFeatures));
