...
subscriptionRouter.get(
  "/",
  validation(subscriptionValidator.validateListPlans),
...
subscriptionRouter.get(
  "/current",
  authenticate,
  validation(subscriptionValidator.validateCurrentSubscription),
...
subscriptionRouter.get(
  ...
  authenticate,
  validation(
    subscriptionValidator.validateSubscriptionStatusQuery,
...
subscriptionRouter.get(
  ...
  authenticate,
  validation(
    subscriptionValidator.validateSubscriptionHistory,
    REQUEST_SOURCES.QUERY,
  ),
...
subscriptionRouter.post(
  ...
  idempotency(false),
  validation(
    subscriptionValidator.validateVerifyGoogleSubscription,
...
subscriptionRouter.post(
  ...
  idempotency(false),
  validation(
    subscriptionValidator.validateRestoreGoogleSubscriptions,
    REQUEST_SOURCES.BODY,
  ),
