...
const auditActorSchema = new Schema(
  {
    type: { type: String, enum: ['user', 'admin', 'system'], default: 'system', index: true },
    user: { type: Schema.Types.ObjectId, ref: 'User', default: null, index: true },
    device: { type: Schema.Types.ObjectId, ref: 'UserDevice', default: null, index: true },
  },
  { _id: false },
);
...
const auditLogSchema = createBaseSchema({
  ...
  requestId: { type: String, trim: true, maxlength: 64, default: null, index: true },
